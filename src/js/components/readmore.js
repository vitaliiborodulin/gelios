...
(function ($) {
  ...
  Readmore.prototype = {
    init: function () {
      ...
      $(this.element).each(function () {
        ...
        if (current.outerHeight(true) <= maxHeight + heightMargin) {
          ...
          current
            .addClass("readmore-js-section " + $this.options.collapsedClass)
      ...
      $(element).animate(
        { height: newHeight },
        {
          ...
          complete: function () {
            ...
            $(this)
              .removeClass(
                $this.options.collapsedClass + " " + $this.options.expandedClass
              )
    ...
    setBoxHeight: function (element) {
      var el = element
          .clone()
          .css({ height: "auto", width: element.width(), overflow: "hidden" })
          .insertAfter(element),
